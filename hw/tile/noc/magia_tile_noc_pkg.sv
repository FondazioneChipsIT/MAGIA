...
package magia_tile_noc_pkg;
    ...
    localparam sam_rule_t[SamNumRules-1:0] Sam = floo_axi_nw_mesh_1x2_noc_pkg::Sam;

    // Actual declaration of RouteCfg
    localparam route_cfg_t RouteCfg = floo_axi_nw_mesh_1x2_noc_pkg::RouteCfg;
